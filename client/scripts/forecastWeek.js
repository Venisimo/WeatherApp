    ...
    fetch(apiMap).then(response => response.json()).then(
        json => {
                ...
                function forecast() {
                    ...
                    apiWeatherNotActive = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&hourly=temperature_2m,relativehumidity_2m,weathercode,surface_pressure,windspeed_10m&daily=sunrise,sunset&current_weather=true&windspeed_unit=ms&forecast_days=8&timezone=auto&temperature_unit=${degressNotActive}`
